...
def traineval(est: Estimator, xtrain, ytrain, xtest, ytest, squaring, df, randomseed):
    ...
    if df == 1:
        ...
        dfHyper = pd.read_csv(
            r"C:\Users\Claire\GIT_REPO_1\CSCthesisPY\HYPEROPTHYPERPARAMETERS\model_" + ml_learner + randstring + suffixpre + ".csv",
            ";")
    ...
    dfHyper.to_csv(
        r"C:\Users\Claire\GIT_REPO_1\CSCthesisPY\HYPEROPTHYPERPARAMETERS\model_" + ml_learner + randstring + suffix + ".csv", ";")
