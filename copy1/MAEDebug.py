...
dftest = pd.read_csv(r"C:\Users\Claire\GIT_REPO_1\CSCthesisPY\IWPC_Imputed_74.csv", ";")
model = "Gage"
dfKey = dftest[["Gage_Pred", "Dose_mg_week"]]
doseTrue = dfKey["Dose_mg_week"]
dosePred2 = dfKey[model + '_Pred']
mae_Gage = score_mae(doseTrue, dosePred2)
print('mae is ', mae_Gage)