...
for imp in range(impNumber):
    ...
    for file in filesImp:
        ...
        if df == 1:
            ...
            lasso_random = RandomizedSearchCV(estimator=lasso, param_distributions=random_grid, n_iter=100, cv=3, verbose=2,
            ...
            grid_search = GridSearchCV(estimator=lasso, param_grid=param_grid,
                                       cv=3, n_jobs=-1, verbose=2)# Create the parameter grid based on the results of random search
