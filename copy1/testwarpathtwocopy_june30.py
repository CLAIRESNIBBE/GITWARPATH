    ...
    for file in filesImp:
        ...
        if True:
            ...
            if True:
                ...
                MLPR2 = MLPRegressor(hidden_layer_sizes=(15,3,), learning_rate='adaptive',learning_rate_init = 0.002, max_iter=2900,activation="relu")
                ...
                MLPR4A = MLPRegressor(hidden_layer_sizes=(30,), activation="relu", learning_rate='adaptive',max_iter=3200, learning_rate_init=0.003)
