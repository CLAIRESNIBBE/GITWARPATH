...
def main():
    ...
    for file in filesImp:
        ...
        print(dfmod.info())
        #dfmod["Weight_kg"] = str(dfmod['Weight_kg']).str.replace(',', '.')
        #dfmod["Weight_kg"] = dfmod["Weight_kg"].astype("float")
        #dfmod["Weight_kg"] = dfmod["Weight_kg"].astype("string")
        #dfmod["Height_cm"] = str(dfmod["Height_cm"]).str.replace(',', '.')
        ...
        #dfmod['AgeLower'] = dfmod['Age_years'].str.replace(',', '.')
